...
Open Energy Transition actively uses, and extend PyPSA, for the purposes of studies, consultations, workshops, presentations, conferences and projects.

- Any such modifications are backfed upstream, to the original PyPSA-X repository.

The code gets reviewed & modified by dozens of associates/contributors in power systems planning, operation & energy economics, many of whom are experts/PhDs in their specific areas.
