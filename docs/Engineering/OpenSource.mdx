...
<MaintainerTag maintainerEmails={["fabrizio.finozzi@openenergytransition.org","johannes.hampp@openenergytransition.org"]} />
...
People often believe it is enough to say "use this however you like" for a project and be done with it.
This is not the case and a creates more problems than it solves.
Always add a license to your projects, even if it is just a simple one.

:::

Any open source (or open data) project that we work on should have a license.
A license specifies the legal terms under which the project can be used, modified, and shared by others.
It is an essential document for yourself to avoid the risks of liability and it enables others to use your work legally and responsibly the way you intended.

Choosing a license can be difficult and should be done at the start of a project after some consideration.
Ask within the team for advice.
We usually use the following licenses for our projects:
...
Some projects are exceptions and use different licenses after deliberation.
See [our copyright and attribution guidelines](./CopyrightAndAttribution.mdx) for details on how we license projects.
