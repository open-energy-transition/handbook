...
* **Squash Merges**: Always squash PRs to keep the `main` branch history linear and clean, except if your repo is a fork (use merge commits when merging upstream). See [below](#squash-your-prs) for the reasoning behind this policy.
