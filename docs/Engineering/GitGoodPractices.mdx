...
To present a clean and organized repository, the branch naming conventions *type_description* shall be used. Both *type* and *description* are indicative of the kind of changes that will be made in the branch. The proposed types are:
...
To present a clean and organized `git log`, the commit message naming conventions *keyword:commit message* shall be used. Both *keyword* and *commit message* are indicative of the kind of changes that are proposed in that particular commit. The proposed keywords are:
