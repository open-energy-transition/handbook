...
To present a clean and organized repository, the following branch naming conventions should be followed <type>_<description>. The type is usually indicative of the kind of changes that will be made in the branch. The proposed types are:
