...
To present a clean and organized repository, the following branch naming conventions should be used *type_description*. The *type* is usually indicative of the kind of changes that will be made in the branch. The proposed types are:
...
The *description* conveys a short understanding of what the change in the branch will deliver.
