...
Whilst, the above command will print the report in the terminal, you can also export the report to a file using the `-o` flag followed by the desired output format (e.g., `json`, `table`, `cyclonedx`, etc.) and the output file name. For example:
