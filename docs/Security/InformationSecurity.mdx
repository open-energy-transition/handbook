...
To facilitate this classification and make it easy to identify the security classification of documents, we have added a table with metadata including security classification to most of our [template documents](TemplateDocuments) which use the Internal classification by default. Note that the security classification is **mandatory**, other fields such as version and owner are recommended but you are free to adapt it to your usage.
