...
Regardless of the project category, all OET code must adhere to these baseline standards:
...
| **Open models** | Follow TODO standard for Secure Repo, Secrets. |
| **Dashboards of public data** | Follow TODO standard for Secure Repo, Secrets. |
| **Open tools** | Follow OpenSSF Scorecard, TODO standard for Secure Repo, Secrets. |
| **Products & platforms** | Follow OpenSSF Scorecard, OWASP for web applications, TODO standard for Secure Repo, Secrets. |
