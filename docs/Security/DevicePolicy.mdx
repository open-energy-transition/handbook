...
* As mentioned above, we highly recommend using the anti-malware tool [Falcon](#falcon). It is mandatory if you are working on Confidential information. If not, you may use another tool that is approved by our Information Security Officer.
