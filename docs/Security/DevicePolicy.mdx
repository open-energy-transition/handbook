...
* Follow the hostname convention `OET-[CountryCode]-[OperatingSystem]-[EmployeeInitials]-[ID]`, e.g. `OET-NL-linux-SK-003`. See the [laptop register](https://docs.google.com/spreadsheets/d/1Hely8oQGtZPoYj2gzdKzBYK_clhTdYHIcYQdLpcW_4g/edit?gid=0#gid=0) for existing IDs to ensure your hostname is unique.
