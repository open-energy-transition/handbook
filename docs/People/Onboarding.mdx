...
1. The device you're working on has full disk encryption enabled. If one is being purchased, please add this option. If that's not possible at checkout, please activate it once you receive the device. In either instance, if you're not sure how, you can ask our Software Engineering Team or People Team.
