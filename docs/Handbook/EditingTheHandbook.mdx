...
To open the Web IDE, please copy the name of the branch you just provided in the following url

`https://github.dev/open-energy-transition/handbook/tree/<branch-name>`

Place the url in your browser. This will open the Web IDE. If you want to add a new page, click on _docs_ and then click on the left button to create a new page or the one on the right to create a new folder.
