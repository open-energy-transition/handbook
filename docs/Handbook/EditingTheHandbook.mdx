...
The [README](https://github.com/open-energy-transition/handbook/blob/main/README.md) details how to install and fetch the necessary dependencies, generate the JSON for the handbook structure and run a local development server. To contribute, please do the following:
- Fork the repository
