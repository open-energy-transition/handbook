...
- **Use the handbook to discuss a process change**: to propose a change to a process, make a pull request to the handbook. Using another channel to propose a handbook change (email, Google Doc, etc.) is discouraged, as discussed in **Handbook-first approach**.
