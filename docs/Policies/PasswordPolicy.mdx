...
All passwords must be at least **14 characters** long, and this is mandated by an admin policy in 1Pass. The longer, the better — aim for 16 or more where a service allows it. Length is one of the single strongest factors in password security, so do not stop at the minimum if you can help it.
...
1Pass has published [a guide](https://1password.com/blog/how-secure-is-my-password) about creating strong passwords, if you'd like to learn more.
...
* **I have locked myself out of 1Pass**
   * Try and use your recovery codes to get in, then create new codes and save those securely for future use
   * If you need your account to be unlocked through the admin dashboard, ask Quintin to do so
