...
NordPass does not currently offer a built-in feature for sharing credentials with someone outside of NordPass. As a temporary measure, until OET moves all team members to 1Password, NordPass users should use **[Password Pusher](https://pwpush.com)** to share credentials:

   - Go to [pwpush.com](https://pwpush.com) (or the EU instance at [eu.pwpush.com](https://eu.pwpush.com) for GDPR compliance)
