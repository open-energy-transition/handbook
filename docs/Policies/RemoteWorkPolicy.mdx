---
sidebar_label: "Remote Work policy"
---
...
- All those working with OET, on a full-time or part-time basis, including but not limited to:
-- Direct hires (through our German entity)
...
## Work Location
OET is a location-flexible organization. The company does not maintain fixed premises for any official business, and each OETer’s formal place of work is their private residence.
Remote work is the default working model at OET and is considered formally authorized for all roles within scope of this policy.
...
If a chosen work setup impacts performance or collaboration, adjustments may be requested.
Work in public or shared spaces shall only be performed where confidentiality and information security can be ensured in line with Section 9.
...
OET is an outcomes-driven organization.
Performance is measured based on:
 ○ Quality of work
 ○ Delivery against agreed goals
 ○ Contribution to team objectives

Team members are expected to:
 ○ Manage their workflow and use their judgement to prioritize things
 ○ Communicate major blockers and delays for fixed deadlines proactively
...
### **Equipment Provision**
OET may provide:
- A company-issued laptop of suitable specification, where required
-- If this is the case, the OETer is to let their manager know, so that the People Department can source something suitable for them
-- Delivery addresses are to be kept up-to-date in Remote and any other relevant systems. A relevant contact number, and any special delivery instructions, are to be included

### **Bring Your Own Device (BYOD)**
Use of personal devices is permitted, provided that:
- Devices comply with OET’s data security and [encryption requirements](https://open-energy-transition.github.io/handbook/docs/Security/DevicePolicy#device-security-requirements)
...
- The individual has read and acknowledged OET’s [device](https://open-energy-transition.github.io/handbook/docs/Security/DevicePolicy#device-security-requirements) and [data](https://open-energy-transition.github.io/handbook/docs/Security/InformationSecurity) policies
...
### **Devices and BYOD**
OET may provide company-issued devices where required. Personal devices may be used for business purposes only if they meet OET’s [security requirements](https://open-energy-transition.github.io/handbook/docs/Security/DevicePolicy#device-security-requirements) Remote working risks are identified and managed as part of OET’s risk management process.
Devices used for OET work shall:
...
- BYOD use must follow the requirements defined in OET’s [Acceptable Use Policy.](https://docs.google.com/document/d/169YXi2lUckY6_qicAf-FrhZsggqt8XkO/edit)
...
- Internal
- Confidential
If information is not explicitly labelled, it shall be treated as Internal by default.
Confidential information shall only be shared using approved and secure channels. Public or anonymous sharing links must not be used for Confidential information.
...
However, costs are approved and reimbursed on a case-by-case basis.
