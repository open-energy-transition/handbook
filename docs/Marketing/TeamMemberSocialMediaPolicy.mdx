...
Please see the [External Communication and Social Media Policy](../Policies/ExternalCommunicationPolicy/), which outlines tone of voice, company values, and legal requirements when engaging in external communication. This includes showing respect for partners and being open, respectful, and professional.
