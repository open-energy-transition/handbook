...
A slide deck template is available on the company [Google Drive](https://docs.google.com/presentation/d/1uq9vFDLqzjs5wcra-26k10tyrjaDSaR8-R4K3ITTe5Q).
...
* **Project overview**: A summary of the project, including links to the results. This slide is an important asset to build a record of the past projects.
