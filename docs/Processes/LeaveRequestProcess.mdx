...
Please read this section before continuing in the leave guide.

- It's very important that you keep a record of your leave days, outside of Remote. The platform may not allocate, roll over, deduct, etc. leave days properly in certain circumstances - especially when shifting from one year to the next. Please maintain your own leave record, and cross-reference. On the last work day of the year, please note down your balance, and make sure it is correct on the 1st of the following year. If not, please message our Head of People for adjustments in Remote.
...
- **Extended leave (above two weeks):**
  - There is no limit on the number of leave days you can request at one time. However, please consult the above individuals as early as possible to increase the chances that your request can be accommodated without issues.
