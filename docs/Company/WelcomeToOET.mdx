...
Please review and sign your contract as the first step. Ensure all details are correct, and feel free to ask our Head of People, [Quintin](mailto:quintin.coetzee@openenergytransition.org) if you have any questions. The People Team will securely file your contract, but you should always keep a copy at hand in your own device(s) or storage.
...
Please also note that we will request you to install encryption software as a security measure. We will also ask you to log the serial number of your device in our asset tracker, after you receive it. If you have any questions about this, please ask our Head of People.
...
Please be aware of spam emails, which may look like a welcome message, or some kind of request from an OETer. Any emails from us will come from our domain, @openenergytransition.org. If you get an email that looks like it's from a member of your team, but it doesn't use that domain, please flag it as spam, and let our Software Engineering Team know about it soonest.

Make sure to set up a profile picture and an email signature (use a teammate’s signature as an example).
We also also recommended you setup an [appointment schedule in Google Calendar](https://support.google.com/calendar/answer/10729749?hl=en) and include this link in your signature, so people can book meetings without the usual availability ping-pong needed to agree on dates and times!
...
- If you require business cards for conferences or other purposes, please reach out to Charlotte, our Marketing Lead. She has specific templates we all use.
...
### Prio talk thread
Everyone has a "prio talk" thread in the Discussion channel that must please be updated every Monday with:
...
Not only does this thread help with broad organizational oversight and planning, but with everyone working remotely, this practice helps the team stay connected with regards to what people are up to each week and encourages helpful exchange on topics.

Use **markdown format** for titles and bullets (follow examples from Max's thread). Markdown enhances readability and consistency; ChatGPT or other LLMs can help you convert files to markdown, or structure them using this format from the get-go. For guides to Discord-specific markdown, you can go [here](https://support.discord.com/hc/en-us/articles/210298617-Markdown-Text-101-Chat-Formatting-Bold-Italic-Underline) and [here](https://www.youtube.com/watch?v=nm0sJihG70Y).
...
- Please add Open Energy Transition as the organization you work with on GitHub. This is required for some scripting-based assessments.
- Then, kindly check you are listed [here](https://github.com/orgs/open-energy-transition/people). You can also star the PyPSA page [here](https://github.com/PyPSA/PyPSA) to follow along. If you have any questions, feel free to ask Quintin.
...
- **It's a work in progress**: Our Handbook is always evolving, and many pages within are still placeholders. If you are looking for specific information and cannot find it, please reach out to our People Team.
...
- If a task code is missing, reach out to Andris to request one (do NOT create one yourself).
...
- For questions about tools, interpreting internal policies or procedures, or any other Operations and Business Strategy-related matter, please feel free to reach out (ideally via Discord) to either our People Team or our Finance Team, as applicable.
