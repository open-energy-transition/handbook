...
You can find our templates in the following location: OET Shared Drive > Templates > Clean Templates.
...
Please check with an HOD. Likely our Head of People Quintin will know. But, in their absence, another HOD may also know, or be able to help you find it, if it does exist.
...
- Check in with Quintin, to ask him about creating a new template, using our consistent style.
...
- If you create your own template, please share it with Quintin before using it, so he can review it.
