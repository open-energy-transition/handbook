...
Each Department has various Team Leads and OS Coordinators reporting to the respective Head of Department. And, each Team Lead may have various OETers reporting into them. As a result, communication flows easily not only vertically, but also horizontally, across Teams and Departments. We can easily get things done on our own, and easily work together when a project requires that.

# Presentation Slides

<ControlledDocBanner />

The company structure is available in the following [presentation](https://drive.google.com/file/d/19HYjjC4hB79Ccd-OymvOxANqbYPcL02_/view?usp=sharing), which we shared with all OETers in March 2025, at the start of the rollout.
