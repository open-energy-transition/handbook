...
OET is structured around six Departments. Heads of Department are in brackets alongside.

* People & Culture (Quintin Coetzee)
* Operations & Strategy (Victor Martinez)
* Software Engineering (TBD)
* Research & Market Development (Harry van der Weijde)
* Energy Tools & Data (Hazem Abdel-Khalek)
* Energy System Modeling (Martha Frysztacki)
...
The company structure is available in the following [presentation](https://docs.google.com/presentation/d/1TATFW1ixj26SEx0Jkun3K5UircP8Iygfxv3IwGO2C0c/edit?usp=sharing), which we shared with all OETers in March 2025, at the start of the rollout. These will be updated with any future changes in OET's structure.
