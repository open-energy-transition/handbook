...
Please also setup an appointment schedule in your Google Calendar, so external people can book meetings with you withouth the usual back-and-forth ping-pong on checking availabilities.
