...
We also recommend the free and open source service [cal.com](https://cal.com/) which you can link to your Google Calendar and create links that you can share with external people to book meetings with you. Please add your [cal.com](https://cal.com/) link to your email signature, just above the OET logo.
