...
## Non-tech staff
Also non-tech staff such as HR, design, marketing, etc. are encourage to set-up a GitHub-account and seek to be added to the OET-team of contributors.

To get a good overview over open modeling, they can have a read in the following articles (all can be found online):
